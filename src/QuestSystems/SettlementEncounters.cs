...
namespace AshAndEmber
{
    public static partial class SettlementEncounters
    {
        ...
        // How many recently-fired encounter names to remember (prevents back-to-back repeats).
        public const int   RecentEncounterMemory = 8;
        ...
        private static int    _mothersPleaCountdown        = 0;  // days until Mother's Plea follow-up
        private static int    _weaponInventorFound         = 0;  // 1 after the weapon-inventor event fires (one-time)
        // Recent encounter names — not persisted; resets on reload to let the game breathe
