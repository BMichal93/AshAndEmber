...
- **Added a new settlement questline: The Scholar's Bargain.** Gated on clan tier ≥ 2 and firing when you enter or leave a town/castle your clan owns, a wandering scholar (Ambrose Voss) offers research that could give you an edge over your rivals, in exchange for a patron's protection. Accept and he settles in your castle; refuse, review his papers first (an Engineering check), or have him arrested and interrogated (Honour/Mercy cost, and he does not survive it).
...
- **You are paid every week** — your party's full upkeep plus a small bounty that grows with your clan's standing — from the commander's own coffers (or the realm's, if he's short). When he holes up in a town or castle, you wait there with him.
- **Riding off on your own — clicking anywhere on the map — ends the service.** Before your term is up that's **desertion**: you're warned first, then branded (rising crime against the realm and lost standing with the commander), heavier the more of the term you leave unserved. **Serve the full term** and you're released cleanly with a parting bonus and their thanks. You can also settle up face-to-face with your commander in conversation.
