...
### Fixes — the second production audit
- **The year is 84 days long, everywhere.** A handful of encounters and the Ashen age-hold still counted 365-day years, so their tolls landed ~4× heavier than written: "you will age three years" aged you thirteen, the healer's double-mending cost forty-three years instead of ten, the cursed trinket's fifty-year drain was a guaranteed death sentence, the witches' dance gave back nine years instead of two, and two long-countdown consequences (the fire-touched child, the tavern night) fired half a lifetime late. The Ashen lords' eternal age of 35 likewise snapped back to ~30 instead of 35 whenever it corrected. All now use the Bannerlord year (4 seasons × 21 days).
- **The fire no longer bills the same days twice.** Growing physically older (ruins, rites, sea bargains, curses) also quietly lowered the age at which the fire burns out — every aged day was paid double, and every rejuvenated day refunded double. Physical aging and the casting ledger are now separate accounts, as the Ledger of Years always claimed.
- **The retired pipeline's promises are honoured by the unified magic.** Talents and rites that still exist (or live on in old saves) but whose battle effects were lost in the element-magic merge work again: **Tempered** cuts every battle cast's toll by a quarter (deepening past age 40), **Kinship** cheapens the fire beside allied mage lords, the **Temple covenant** steadies it by a day, the **Unbroken Ward** bears two days of it while the Seal holds, **Warcast** lets you draw with a weapon in hand, **Flashfire** sometimes echoes a working free, and **Resonance** spares the day's first map working (and one in four after). A cast is still never free of its floor.
- **Sorcery in the tournament is once again disqualification** — the arena check was lost in the input-path merge; the crowd forgives nothing again.
- **Mage lords who die no longer haunt the ledger** — a dead lord's spent-life record is now released with the rest of his registry state (a slow save-file leak over long campaigns).
- **The Ashen decision can fire again in a fresh campaign** — starting a new game after an unresolved century-prompt no longer leaves the choice permanently jammed.
- **The Tribes' raid-spoils cooldown counts days now**, not raid battles fought anywhere in Calradia by anyone.
- **Every behaviour registration is individually shielded** at game start, as the mod-conflict convention always demanded — one failing constructor can no longer take the rest of the mod down with it.
